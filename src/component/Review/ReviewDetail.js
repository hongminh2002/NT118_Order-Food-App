    ...
    return (
        ...
        <View 
            ...
            <View style={{flexDirection:'row', top:10}}>
                ...
                <Image source={require('../../asset/Spot.png')} style={{left:10, alignSelf:'center'}} />
...
const CustomerName = (props) => (
    <View> 
      <Text style={{
        ...
        fontWeight:'600',
        left:10}}>
        {props.review.customerName}</Text>
    </View>
  );
...
const CustomerImage = (props) => (
    <View>
      <Image 
        source= {props.review.customerImage} 
        />
    </View>
);
